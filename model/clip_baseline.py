...
from model.baseline_pooling import BaselinePooling
...
class CLIPBaseline(nn.Module):
    ...
    def forward(self, data, return_all_frames=False):
        ...
        text_features = text_features / text_features.norm(dim=-1, keepdim=True)    #对这些特征向量进行归一化处理，即将它们除以它们在最后一个维度上的范数
