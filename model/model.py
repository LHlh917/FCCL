...
from utils1.util import state_dict_data_parallel_fix
...
class FrozenInTime(BaseModel):
    def __init__(self,
        ...
        if load_checkpoint not in ["/opt/data/private/LH/LH/xpool/distilbert-base-uncased", None]:
    ...
    def compute_video(self, video_data):
        ...
        video_embeddings = linear(video_embeddings).to(device)
